...
/**
 * Checks if mirror is joined
 */
@Injectable()
export class MirrorJoinedGuard {
  /**
   * Constructor
  ...
  canActivate(route: ActivatedRouteSnapshot): Observable<boolean> {
    return this.checkStore().pipe(
      switchMap(() => {
        ...
        return this.hasModule(id) && this.mirrorJoined(id)
      })
    )
  }
